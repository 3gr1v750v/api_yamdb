    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[reviews.validators.slug_validator])),
            ],
            options={
                'verbose_name': 'Жанр',
        ...
        migrations.AlterField(
            model_name='category',
            name='slug',
            field=models.SlugField(unique=True, validators=[reviews.validators.slug_validator]),
        ),
        migrations.CreateModel(
            name='GenreTitle',
            fields=[
